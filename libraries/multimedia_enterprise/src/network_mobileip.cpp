    ...
    int interfaceId)
{
    ...
    (unsigned short) (getSimTime(node) / SECOND) +
    ...
    int interfaceId)
{
    ...
    (unsigned short) (getSimTime(node) / SECOND) + agentAdvLifeTime;
...
Message* MobileIpCreateRequestPacket(Node* node, Message* msg)
{
    ...
    reqPacket->identification = getSimTime(node);
    ...
    BOOL simulMobility)
{
    ...
    newRegList->identNumber = getSimTime(node);
    newRegList->remainingLifetime = lifetime;

    ListInsert(node, infoList, getSimTime(node), newRegList);
    ...
    MobileIpRegistrationReply* replyPktStruct)
{
    ...
    switch (replyPktStruct->code)
    {
        ...
        case mobileIPRegDenyHAUnknownHAAddress:
        {
            ...
            infoList->remainingLifetime = (unsigned short)(getSimTime(node) / SECOND)
                                       ...
                                       replyPktStruct)
{
   ...
   *((clocktype*) MESSAGE_ReturnInfo(visitorListUpdateMsg)) =
    ...
    else
    {
        ...
        delay = replyPktStruct->lifetime * SECOND - (getSimTime(node)
            - replyPktStruct->identification);
    }
