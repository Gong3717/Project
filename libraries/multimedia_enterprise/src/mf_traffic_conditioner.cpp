    ...
    int* preference)
{
    ...
    tokensGeneratedSinceLastUpdate =
        (Int32)((conditionClassInfo->rate * (getSimTime(node)
    ...
    conditionClassInfo->tokens =
     ...
     conditionClassInfo->lastTokenUpdateTime = getSimTime(node);
    ...
    int* preference)
{
    ...
    tokensGeneratedSinceLastUpdate =
        (Int32)((conditionClassInfo->peakInformationRate * (getSimTime(node)
            - conditionClassInfo->lastTokenUpdateTime)) / SECOND);
    ...
    int* preference)
{
    ...
    conditionClassInfo->avgRate = bytesInTimeSlidingWindow /
        ((getSimTime(node) - conditionClassInfo->lastTokenUpdateTime) /
