    ...
    int* preference)
{
    ...
    if(sfDirection == DOT16_DOWNLINK_SERVICE_FLOW ) {
        tokensGeneratedSinceLastUpdate =
            (Int32)((stationInfo->dlRate * (getSimTime(node)
        ...
        stationInfo->dlTokens =
         ...
         stationInfo->dlLastTokenUpdateTime = getSimTime(node);
        ...
        tokensGeneratedSinceLastUpdate =
            (Int32)((stationInfo->ulRate * (getSimTime(node)
        ...
        stationInfo->ulTokens =
         ...
         // Note the last update time.
         stationInfo->ulLastTokenUpdateTime = getSimTime(node);
