                      ...
                      unsigned char* macAddress)
{
    ...
    ssInfo->lastRangeGrantTime = getSimTime(node);
                                 ...
                                 int* dlMapLength)
{
    ...
    if (dot16Bs->dcdScheduled)
    {
        ...
        dot16Bs->lastDcdSentTime = getSimTime(node);
    ...
    if (dot16Bs->ucdScheduled)
    {
        ...
        dot16Bs->lastUcdSentTime = getSimTime(node);
                           ...
                           Dot16CIDType cid)
{
    ...
    while (index < startIndex + length)
    {
        ...
        if (tlvType == TLV_REP_RSP_CinrReport)
        {
            ...
            ssInfo->lastDlMeaReportTime = getSimTime(node);
        }
                                ...
                                MacDot16SignalMeasurementInfo meanMeas)
{
    ...
    if (found)
    {
        ...
        ssInfo->nbrBsSignalMeas[i].dlMeanMeas.measTime = getSimTime(node);
                                   ...
                                   PhySignalMeasurement* signalMea)
{
    ...
    ssInfo->lastUlMeaTime = getSimTime(node);
}
                ...
                case DOT16_TIMER_FrameBegin:
                {
                    ...
                    if (dot16->dot16eEnabled &&
                        ...
                        (dot16Bs->lastNbrAdvSent +
                         DOT16_BS_MOB_ADV_ADV_INTERVAL) < getSimTime(node))
                    {
                        ...
                        MacDot16BsScheduleMgmtMsgToSs(node,
                                                      ...
                                                      DOT16_BROADCAST_CID,
                                                      mobNbrAdv);
                        dot16Bs->lastNbrAdvSent = getSimTime(node);
