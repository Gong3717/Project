                     ...
                     const NodeInput* nodeInput)
{
    ...
    {
        if (phy802_15_4->thisPhy->channelListening[i] == TRUE)
        {
            break;
        }
    }
    ...
    PropRxInfo* propRxInfo)
{
    ...
    if ((phy802_15_4->mode != PHY_TRX_OFF))
    {
        ...
        phy802_15_4->stats.turnOnPeriod
            = getSimTime(node) - phy802_15_4->stats.turnOnTime;
    }
    else
    {
        if (DEBUG)
                                        ...
                                        clocktype* endSignalTime)
{
    ...
    *frameError = phy802_15_4->rxMsgError;
    ...
    phy802_15_4->rxOnPeriod +=
        (getSimTime(node) - phy802_15_4->rxTimeEvaluated);

#if 0
        {
        // added for energy model
        double duration = (double)(getSimTime(node) -
                                     ...
                                     PropRxInfo *propRxInfo)
{
    ...
    phy802_15_4->rxOnPeriod += (getSimTime(node)
    ...
    phy802_15_4->stats.turnOnPeriod = getSimTime(node)
...
void Phy802_15_4ActivationNode(Node* node, Int32 phyIndex)
{
    ...
    {
        Phy802_15_4ChangeState(node,phyIndex, PHY_IDLE);
        phy802_15_4->activationTime = getSimTime(node);
...
void Phy802_15_4DeactivationNode(Node* node, Int32 phyIndex)
{
    ...
    if (phy802_15_4->mode != PHY_TRX_OFF)
    {
        phy802_15_4->deactivationTime = getSimTime(node);
    }
