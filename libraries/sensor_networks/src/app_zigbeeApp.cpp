                         ...
                         TosType tos)
{
    ...
    zigbeeAppClient->sessionStart = getSimTime(node) + startTime;
    zigbeeAppClient->sessionIsClosed = FALSE;
    zigbeeAppClient->sessionLastSent = getSimTime(node);
    zigbeeAppClient->sessionFinish = getSimTime(node);
                         ...
                         short sourcePort)
{
    ...
    ZigbeeAppServer->sessionStart = getSimTime(node);
    ZigbeeAppServer->sessionFinish = getSimTime(node);
    ZigbeeAppServer->sessionLastReceived = getSimTime(node);
