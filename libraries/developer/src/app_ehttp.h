 ...
 */
void
AppEHttpServerInit(Node *nodePtr, Address serverAddr, char *baseDir);
...
void AppEHttpServerMessageToClient(Node *node, AppDataEHttpServer *serverPtr, char * output, int length);
...
int AppEHttpServerFileSend(Node * node, AppDataEHttpServer * serverPtr, char * fileName, int fileSize);
