...
// DESCRIPTION :: member data of logical subnet
// **/
...
// DESCRIPTION :: data of logical subnet
// **/
...
// RETURN :: LogicalSubnet* : Poiter to LogicalSubnet
// **/
...
// PARAMETERS  ::
// + node       : Node* : Pointer to node.
// + nodeId     : NodeAddress : node identifier
// + infInx     : int : interface Index
// RETURN      :: NodeAddress : returns address of node
// **/
...
// + nodeId     : NodeAddress : node identifier
// + infInx     : int : interface Index
// RETURN      :: const LogicalSubnet* : Pointer to LogicalSubnet
// **/
