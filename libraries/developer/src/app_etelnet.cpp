...
static struct ptentry parsetab[] =
            {{"stats", AppETelnetServerCommandTelnetStats},
            {"conn", AppETelnetServerCommandTelnetConn},
            {"help", AppETelnetServerCommandHelp},
            {"exit", AppETelnetServerCommandShellQuit},
            {"?", AppETelnetServerCommandHelp},
            /* Default action */
            {NULL, AppETelnetServerCommandUnknown}};
...
{
    AppETelnetServerShellOutput(node, serverPtr, "Available commands:\n");
    AppETelnetServerShellOutput(node, serverPtr, "stats  - show network statistics\n");
    AppETelnetServerShellOutput(node, serverPtr, "conn    - show TCP connections\n");
    AppETelnetServerShellOutput(node, serverPtr, "help, ? - show help\n");
    AppETelnetServerShellOutput(node, serverPtr, "exit    - exit shell \n");
}
 ...
 */
void
AppETelnetServerCommandUnknown(Node *node, AppDataETelnetServer *serverPtr, char *str)
{
    if(strlen(str) > 0) {
        AppETelnetServerShellOutput(node, serverPtr, "unknown command\n");
    }
}
