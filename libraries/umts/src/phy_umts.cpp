// Copyright (c) 2001-2004, Scalable Network Technologies, Inc.  All Rights Reserved.
//                          6100 Center Drive
//                          Suite 1250
        ...
        while (msgList != NULL)
        {
            ...
            if (cdmaBurst->inError == FALSE)
            {
                    ...
                    (cdmaBurst->phChType != UMTS_PHYSICAL_SSCH))
                {
                    ...
                    cdmaBurst->rxTimeEvaluated = getSimTime(node);
    ...
    if (thisPhy->phyStats && phyCellular->collectStatistics)
    {
        ...
        phyUmts->stats.energyConsumed
            += (double) BATTERY_RX_POWER
               * (getSimTime(node) - phyUmts->stats.turnOnTime);
