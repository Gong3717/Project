...
// /**
// FUNCTION   :: UmtsLayer3UeFindPhoneCallApp
// LAYER      :: Layer 3
// PURPOSE    :: Look for the phone call app Info from the appList
// + node      : Node*             : Pointer to node.
// + ueL3      : UmtsLayer3Ue*     : Pointer to the umts ue L3 data
...
// **/
static
UmtsLayer3UeAppInfo* UmtsLayer3UeFindPhoneCallApp(
                        Node* node,
                        UmtsLayer3Ue* ueL3,
                        NodeId appSrcNodeId,
                        int appId)
...
// LAYER      :: Layer 3
// PURPOSE    :: Alert the PHONECALL application
// PARAMETERS ::
// + node           : Node*                  : Pointer to node.
// + umtsL3         : UmtsLayer3Data*        : Pointer to UMTS Layer3 data
        ...
        UmtsLayer3UeAppInfo* ueFlow)
{
    ...
    MESSAGE_InfoAlloc(node,
                      msgToApp,
                      sizeof(AppPhoneCallArriveMessageInfo));
    AppPhoneCallArriveMessageInfo* callArriveInfo =
        (AppPhoneCallArriveMessageInfo*)MESSAGE_ReturnInfo(msgToApp);
        ...
        UmtsLayer3UeAppInfo* ueFlow)
{
    ...
    MESSAGE_InfoAlloc(node,
                      msgToApp,
                      sizeof(AppPhoneCallAcceptMessageInfo));
    AppPhoneCallAcceptMessageInfo* callInfo =
...
// LAYER      :: Layer 3
// PURPOSE    :: Report a CALL ending to the PHONECALL application
// PARAMETERS ::
// + node           : Node*                  : Pointer to node.
// + umtsL3         : UmtsLayer3Data*        : Pointer to UMTS Layer3 data
// + ueFlow         : UmtsLayer3UeAppInfo*   : Pointer to the call flow data
        ...
        UmtsLayer3UeAppInfo* ueFlow)
{
    ...
    MESSAGE_InfoAlloc(
        node,
        msgToApp,
        sizeof(AppPhoneCallEndByRemoteMessageInfo));
    AppPhoneCallEndByRemoteMessageInfo* callInfo =
...
// LAYER      :: Layer 3
// PURPOSE    :: Report a CALL drop to the PHONECALL application
// PARAMETERS ::
// + node           : Node*                  : Pointer to node.
// + umtsL3         : UmtsLayer3Data*        : Pointer to UMTS Layer3 data
// + ueFlow         : UmtsLayer3UeAppInfo*   : Pointer to the CALL flow data
// + cause          : AppPhoneCallDropCauseType : drop cause
// RETURN           :: void : NULL
// **/
static
void UmtsLayer3UeNotifyAppCallDrop(
        ...
        UmtsLayer3Data* umtsL3,
        UmtsLayer3UeAppInfo* ueFlow,
        AppPhoneCallDropCauseType cause)
{
    UmtsCcMsData* ueCc = ueFlow->cmData.ccData;
    Message* msgToApp = MESSAGE_Alloc(
                            node,
    ...
    MESSAGE_InfoAlloc(node,
                      msgToApp,
                      sizeof(AppPhoneCallDropMessageInfo));
    AppPhoneCallDropMessageInfo* callInfo =
...
// LAYER      :: Layer 3
// PURPOSE    :: Report a CALL rejection to the PHONECALL application
// PARAMETERS ::
// + node           : Node*                  : Pointer to node.
// + umtsL3         : UmtsLayer3Data*        : Pointer to UMTS Layer3 data
// + ueFlow         : UmtsLayer3UeAppInfo*   : Pointer to the CALL flow data
// + cause          : AppPhoneCallRejectCauseType : reject cause
// RETURN           :: void : NULL
// **/
static
void UmtsLayer3UeNotifyAppCallReject(
        ...
        UmtsLayer3Data* umtsL3,
        UmtsLayer3UeAppInfo* ueFlow,
        AppPhoneCallRejectCauseType cause)
{
    UmtsCcMsData* ueCc = ueFlow->cmData.ccData;
    Message* msgToApp = MESSAGE_Alloc(
                            node,
    ...
    MESSAGE_InfoAlloc(node,
                      msgToApp,
                      sizeof(AppPhoneCallRejectMessageInfo));
    AppPhoneCallRejectMessageInfo* callInfo =
...
void UmtsLayer3UeNotifyAppCallReject(
        Node* node,
        UmtsLayer3Data* umtsL3,
        AppPhoneCallStartMessageInfo* callInfo,
        AppPhoneCallRejectCauseType cause)
{
    Message* msgToApp = MESSAGE_Alloc(
                            node,
    ...
    MESSAGE_InfoAlloc(node,
                      msgToApp,
                      sizeof(AppPhoneCallRejectMessageInfo));
    AppPhoneCallRejectMessageInfo* rejectInfo =
        (AppPhoneCallRejectMessageInfo*) MESSAGE_ReturnInfo(msgToApp);
...
// LAYER      :: Layer 3
// PURPOSE    :: Report a CALL clearing event to the PHONECALL application
// PARAMETERS ::
// + node           : Node*                  : Pointer to node.
// + umtsL3         : UmtsLayer3Data*        : Pointer to UMTS Layer3 data
        ...
        Message* msg)
{
    ...
    if (ueFlow)
    {
        //Currently CS domain data are exclusively for PHONE_CALL_APP
        UmtsCcMsData* ueCc = ueFlow->cmData.ccData;
        MESSAGE_SetLayer(msg, APP_LAYER, APP_PHONE_CALL);
        MESSAGE_SetEvent(msg, MSG_APP_CELLULAR_FromNetworkPktArrive);

        MESSAGE_InfoAlloc(node, msg, sizeof(AppPhoneCallPktArrivalInfo));
          ...
          UmtsLayer3UeAppInfo* ueFlow)
{
    ...
    {
        //report to phonecall that call is rejected
        UmtsLayer3UeNotifyAppCallReject(
            node,
            umtsL3,
            ueFlow,
...
void UmtsLayer3UeHandleStartCallMsg(Node *node,
                                    ...
                                    Message *msg)
{
    // get the phone call src dest info
    // initiate call setup
    // start timers
    ...
    UmtsLayer3Ue* ueL3 = (UmtsLayer3Ue*) (umtsL3->dataPtr);
    AppPhoneCallStartMessageInfo* callInfo = (AppPhoneCallStartMessageInfo*)
                                             MESSAGE_ReturnInfo(msg);

    ERROR_Assert(UmtsLayer3UeFindPhoneCallApp(
                    node, ueL3, callInfo->appSrcNodeId, callInfo->appId)
                 == NULL,
                 "Phone call application already exists.");
    ueL3->stat.numMoAppRcvdFromUpper ++;
    ueL3->stat.numMoCsAppRcvdFromUpper ++;
                                  ...
                                  Message *msg)
{
    ...
    UmtsLayer3Ue* ueL3 = (UmtsLayer3Ue*)(umtsL3->dataPtr);
    AppPhoneCallEndMessageInfo* callInfo =
        (AppPhoneCallEndMessageInfo*)MESSAGE_ReturnInfo(msg);

    UmtsLayer3UeAppInfo* ueFlow = UmtsLayer3UeFindPhoneCallApp(
                                    node,
                                    ueL3,
                                       ...
                                       Message *msg)
{
    ...
    AppPhoneCallAnsweredMessageInfo* callInfo =
        (AppPhoneCallAnsweredMessageInfo*)MESSAGE_ReturnInfo(msg);
                                      ...
                                      Message *msg)
{
    ...
    if (ueFlow)
    {
        ...
        {
            //Report to PhoneCallApp a protocol error?
            ueL3->stat.numCsPktDroppedNoResource ++;
        }
    }
    else
          ...
          void* cmd)
{
        ...
        it ++)
    {
        if ((*it)->primaryScCode == rscpVal->priSc)
        {
            ...
            measElem.timeStamp = getSimTime(node);
            ...
            if (measInd->measType == UMTS_MEASURE_L1_CPICH_RSCP)
            {
                ueNodeBInfo->cpichRscpMeas->AddMeasElement(
                     measElem, getSimTime(node));

                ueNodeBInfo->cpichRscp =
                    ueNodeBInfo->cpichRscpMeas->GetAvgMeas(getSimTime(node));
                // GUI
        ...
        if (measInd->measType == UMTS_MEASURE_L1_CPICH_RSCP)
        {
            ...
            (*it)->cpichRscp =
                (*it)->cpichRscpMeas->GetAvgMeas(getSimTime(node));
    ...
    if (!ueNodeBInfo)
    {
        ...
        else if (measInd->measType == UMTS_MEASURE_L1_CPICH_Ec_No)
        {
            ueNodeBInfo->cpichEcNoMeas->AddMeasElement(
                     measElem, getSimTime(node));
            ueNodeBInfo->cpichEcNo =
                ueNodeBInfo->cpichEcNoMeas->GetAvgMeas(getSimTime(node));
            ...
            ueL3->rrcData->subState != UMTS_RRC_SUBSTATE_CELL_DCH))
    {
        if (ueL3->priNodeB && ueL3->priNodeB == ueNodeBInfo)
        {
            ...
            ueL3->priNodeB->cpichRscp =
                ueL3->priNodeB->cpichRscpMeas->GetAvgMeas(getSimTime(node));
            ...
            ueL3->rrcData->subState == UMTS_RRC_SUBSTATE_CELL_DCH)
    {
        ...
        if (needRepMeas ||
            (ueL3->lastReportTime +
            UMTS_DEFAULT_CELL_EVALUATION_TIME) < getSimTime(node))
        {
                              ...
                              Message* msg)
{
    ...
    if (ueFlow)
    {
        ...
        if (ueCc->state == UMTS_CC_MS_RELEASE_REQUEST)
        {
            ...
            {
                ueCc->state = UMTS_CC_MS_NULL;
                //TODO: notify PhoneCall the call is ended
        ...
        int msgSize)
{
    ...
    if (ueFlow)
    {
            ...
            ||ueCc->state == UMTS_CC_MS_CALL_DELIVERED)
        {
            ...
            //Notify the phoneapp that call is anwsered
        ...
        int msgSize)
{
    ...
    //Send Alerting to the PhoneCall application
        ...
        int msgSize)
{
                            ...
                            == UMTS_CC_MS_CONNECT_REQUEST)
    {
       ...
       //No need to send a CALL_ACCEPT message to the phonecall app
            ...
            int networkType)
{
    ...
    appInfo->lastActiveTime = getSimTime(node);
