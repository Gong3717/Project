...
typedef enum GENERIC_SLOT_CSMA_ENUM {
    MGENERIC_CSMA_BASIC, // Basic Mode of Slot CSMA
    MGENERIC_CSMA_SHORT, // CSMA-Short
    MGENERIC_CSMA_NORMAL, // CSMA-Normal
    MGENERIC_CSMA_SHORT_IMMEDIATE, // CSMA-Short Immediate Access
    MGENERIC_CSMA_NORMAL_IMMEDIATE, //CSMA-Normal Immediate Access
} GenericSlotCsmaModeType;
...
#ifdef MILITARY_RADIOS_LIB
    GenericSlotCsmaModeType csmaMode; // the access mode for slot csma
#endif // MILITARY_RADIOS_LIB
