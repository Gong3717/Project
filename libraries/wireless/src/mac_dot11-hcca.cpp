                        ...
                        Mac802Address destAddress)
{
    ...
    dot11->hcVars->polledTime = getSimTime(node);
    ...
    int dataRateType)
{
    ...
    clocktype cfpBalanceDuration =
        dot11->hcVars->capEndTime - getSimTime(node);
    ...
    MacDataDot11* dot11)
{
    ...
    else
    {
        ...
        MacDot11eCfpSetEndVariables(node, dot11);
        dot11->hcVars->capPeriodExpired +=
        getSimTime(node)-dot11->hcVars->capStartTime;
        MacDot11StationCheckForOutgoingPacket(node, dot11, FALSE);
    }
    ...
    Message* msg)
{
    ...
    switch (frameType) {
        ...
        case DOT11_QOS_DATA_POLL:
            ...
            dot11->hcVars->txopStartTime = getSimTime(node);
            dot11->hcVars->txopDurationGranted =
    ...
    Mac802Address nextHop)
{
        ...
        dataItem->frameInfo->insertTime = getSimTime(node);
