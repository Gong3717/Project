...
//
    ...
    switch(thisPhy->phyModel) {
		...
		//xyt
		case PHY_FX: {
			PhySphyInit(node, phyIndex, nodeInput);
			break;
		}
    ...
    switch(node->phyData[phyIndex]->phyModel) {
       ...
       case PHY802_15_4: {
		...
		case PHY_FX: {
			switch (msg->eventType) {
			case MSG_PHY_TransmissionEnd: {
				PhySphyTransmissionEnd(node, phyIndex);
				MESSAGE_Free(node, msg);
    ...
    NodeAddress destAddr)
{
    ...
    switch(node->phyData[phyNum]->phyModel) {
	  ...
	  //xyt
		case PHY_FX: {
			PhySphyStartTransmittingSignal(node, phyNum, msg, useMacLayerSpecifiedDelay, delayUntilAirborne);
			break;
		}
   ...
   PropRxInfo *propRxInfo)
{
    ...
    if (node->phyData[phyIndex]->jammerStatistics == TRUE)
    {
        ...
        if (infoPtr != NULL)
        {
            if (*infoPtr == JAM_TYPE_APP)
            {
                ...
                {
                    node->phyData[phyIndex]->jammerStartTime = getSimTime(node);
    ...
    switch(node->phyData[phyIndex]->phyModel) {
       ...
       case PHY802_15_4: {
		...
		//xyt
		case PHY_FX: {
			PhySphySignalArrivalFromChannel(node, phyIndex, channelIndex, propRxInfo);
			break;
		}
   ...
   PropRxInfo *propRxInfo)
{
        ...
        if (infoPtr != NULL)
        {
            if (*infoPtr == JAM_TYPE_APP)
            {
                ...
                if (node->phyData[phyIndex]->jamInstances == 0)
                {
                    node->phyData[phyIndex]->jamDuration -= (node->phyData[phyIndex]->jammerEndTime -
                        node->phyData[phyIndex]->jammerStartTime);
                    node->phyData[phyIndex]->jammerEndTime = getSimTime(node);
                    node->phyData[phyIndex]->jamDuration += (node->phyData[phyIndex]->jammerEndTime -
                        node->phyData[phyIndex]->jammerStartTime);
                }
            }
    ...
    switch(node->phyData[phyIndex]->phyModel) {
		...
		//xyt
		case PHY_FX: {
			PhySphySignalEndFromChannel(node, phyIndex, channelIndex, propRxInfo);
			break;
		}
    ...
    switch (phyModel) {
        ...
        case PHY_GSM:
            ...
            case PHY_CELLULAR:
            {
                ...
                txPhyUmts = (PhyUmtsData* )txPhyCellular->phyUmtsData;
            ...
            int phyIndex)
{
    ...
    switch (phyModel) {
       ...
       case PHY_FCSC_PROTOTYPE:
		...
		case PHY_FX:
			PhyDataFx* phy_sphy;
			phy_sphy = (PhyDataFx*)thisRadio->phyVar;
			bandwidth = phy_sphy->channelBandwidth;
			break;
...
#ifdef ADDON_BOEINGFCS
        case PHY_SRW_ABSTRACT: {
      //    SRW::Nexus::PHY::InterferenceArrivalFromChannel(node, phyIndex, channelIndex, propRxInfo);
        } break;
#endif // FCS
        default: {
            ERROR_ReportError("Unknown or disabled PHY model\n");
...
#ifdef ADDON_BOEINGFCS
        case PHY_SRW_ABSTRACT: {
      //    SRW::Nexus::PHY::InterferenceEndFromChannel(node, phyIndex, channelIndex, propRxInfo);
        } break;
#endif // FCS
        default: {
            ERROR_ReportError("Unknown or disabled PHY model\n");
...
//xyt 0412
void returnAllInfoTypeName(string& nameString, Message *msg)
{

	for (std::vector<MessageInfoHeader>::iterator i = msg->infoArray.begin();
		i != msg->infoArray.end(); ++i)
	{
		switch (i->infoType)
		{
		case INFO_TYPE_UNDEFINED: nameString.append("INFO_TYPE_UNDEFINED\n"); break;

		case INFO_TYPE_AbstractCFPropagation: nameString.append("INFO_TYPE_AbstractCFPropagation\n"); break;
		case INFO_TYPE_AppName: nameString.append("INFO_TYPE_AppName\n"); break;
		case INFO_TYPE_StatCategoryName: nameString.append("INFO_TYPE_StatCategoryName\n"); break;
		case INFO_TYPE_DscpName: nameString.append("INFO_TYPE_DscpName\n"); break;
		case INFO_TYPE_SourceAddr: nameString.append("INFO_TYPE_SourceAddr\n"); break;
		case INFO_TYPE_SourcePort: nameString.append("INFO_TYPE_SourcePort\n"); break;
		case INFO_TYPE_DestAddr: nameString.append("INFO_TYPE_DestAddr\n"); break;
		case INFO_TYPE_DestPort: nameString.append("INFO_TYPE_DestPort\n"); break;
		case INFO_TYPE_DeliveredPacketTtlTotal: nameString.append("INFO_TYPE_DeliveredPacketTtlTotal\n"); break;
		case INFO_TYPE_IpTimeStamp: nameString.append("INFO_TYPE_IpTimeStamp\n"); break;
		case INFO_TYPE_DataSize: nameString.append("INFO_TYPE_DataSize\n"); break;
		case INFO_TYPE_AbstractPhy: nameString.append("INFO_TYPE_AbstractPhy\n"); break;
		case INFO_TYPE_SendTime: nameString.append("INFO_TYPE_SendTime\n"); break;
		case INFO_TYPE_SubnetId: nameString.append("INFO_TYPE_SubnetId\n"); break;
		case INFO_TYPE_SpectrumInterfaceIndex: nameString.append("INFO_TYPE_SpectrumInterfaceIndex\n"); break;
		case INFO_TYPE_SpectrumManagerInfo: nameString.append("INFO_TYPE_SpectrumManagerInfo\n"); break;
		case INFO_TYPE_VoiceData: nameString.append("INFO_TYPE_VoiceData\n"); break;
		case INFO_TYPE_QNHeaderInfo: nameString.append("INFO_TYPE_QNHeaderInfo\n"); break;
		case INFO_TYPE_MacCesUsapCellHeaderInfo: nameString.append("INFO_TYPE_MacCesUsapCellHeaderInfo\n"); break;
		case INFO_TYPE_MacCesUsapReTxInfo: nameString.append("INFO_TYPE_MacCesUsapReTxInfo\n"); break;
		case INFO_TYPE_MacCesUsapTruePacketInfo: nameString.append("INFO_TYPE_MacCesUsapTruePacketInfo\n"); break;
		case INFO_TYPE_MacCesMonitorPacketInfo: nameString.append("INFO_TYPE_MacCesMonitorPacketInfo\n"); break;
		case INFO_TYPE_NetworkCesIncSincgarsPrecedence: nameString.append("INFO_TYPE_NetworkCesIncSincgarsPrecedence\n"); break;
		case INFO_TYPE_RoutingCesSdrDuplicate: nameString.append("INFO_TYPE_RoutingCesSdrDuplicate\n"); break;
		case INFO_TYPE_NetworkCesIncEplrsCTU: nameString.append("INFO_TYPE_NetworkCesIncEplrsCTU\n"); break;
		case INFO_TYPE_NetworkCesIncEplrsTU: nameString.append("INFO_TYPE_NetworkCesIncEplrsTU\n"); break;
		case INFO_TYPE_MulticastCesSrwMospfGatewayAddress: nameString.append("INFO_TYPE_MulticastCesSrwMospfGatewayAddress\n"); break;
		case INFO_TYPE_MacCesSrwPktAggregate: nameString.append("INFO_TYPE_MacCesSrwPktAggregate\n"); break;
		case INFO_TYPE_MaByteStream: nameString.append("INFO_TYPE_MaByteStream\n"); break;
		case INFO_TYPE_LinkCesWnwAdaptation: nameString.append("INFO_TYPE_LinkCesWnwAdaptation\n"); break;
		case INFO_TYPE_TimeSyncTimerInfo: nameString.append("INFO_TYPE_TimeSyncTimerInfo\n"); break;
		case INFO_TYPE_MacCesSrwSignalQuality: nameString.append("INFO_TYPE_MacCesSrwSignalQuality\n"); break;
		case INFO_TYPE_TransportOverhead: nameString.append("INFO_TYPE_TransportOverhead\n"); break;
		case INFO_TYPE_NetworkOverhead: nameString.append("INFO_TYPE_NetworkOverhead\n"); break;
		case INFO_TYPE_MacOverhead: nameString.append("INFO_TYPE_MacOverhead\n"); break;
		case INFO_TYPE_PhyOverhead: nameString.append("INFO_TYPE_PhyOverhead\n"); break;
		case INFO_TYPE_ALE_ChannelIndex: nameString.append("INFO_TYPE_ALE_ChannelIndex\n"); break;
		case INFO_TYPE_PhyIndex: nameString.append("INFO_TYPE_PhyIndex\n"); break;
		case INFO_TYPE_MdpInfoData: nameString.append("INFO_TYPE_MdpInfoData\n"); break;
		case INFO_TYPE_MdpObjectInfo: nameString.append("INFO_TYPE_MdpObjectInfo\n"); break;
		case INFO_TYPE_SuperAppUDPData: nameString.append("INFO_TYPE_SuperAppUDPData\n"); break;
		case INFO_TYPE_SuperAppTCPData: nameString.append("INFO_TYPE_SuperAppTCPData\n"); break;
		case INFO_TYPE_UmtsRlcPduListInfo: nameString.append("INFO_TYPE_UmtsRlcPduListInfo\n"); break;
		case INFO_TYPE_UmtsRlcSduInfo: nameString.append("INFO_TYPE_UmtsRlcSduInfo\n"); break;
		case INFO_TYPE_UmtsRlcSduSegInfo: nameString.append("INFO_TYPE_UmtsRlcSduSegInfo\n"); break;
		case INFO_TYPE_AppPhoneCallData: nameString.append("INFO_TYPE_AppPhoneCallData\n"); break;
		case INFO_TYPE_UmtsCellSwitch: nameString.append("INFO_TYPE_UmtsCellSwitch\n"); break;
		case INFO_TYPE_OriginalInsertTime: nameString.append("INFO_TYPE_OriginalInsertTime\n"); break;
		case INFO_TYPE_ExternalData: nameString.append("INFO_TYPE_ExternalData\n"); break;
		case INFO_TYPE_UdpFragData: nameString.append("INFO_TYPE_UdpFragData\n"); break;
		case INFO_TYPE_StatsTiming: nameString.append("INFO_TYPE_StatsTiming\n"); break;
		case INFO_TYPE_AppStatsDbContent: nameString.append("INFO_TYPE_AppStatsDbContent\n"); break;
		case INFO_TYPE_StatsDbMapping: nameString.append("INFO_TYPE_StatsDbMapping\n"); break;
		case INFO_TYPE_StatsDbAppSessionId: nameString.append("INFO_TYPE_StatsDbAppSessionId\n"); break;
		case INFO_TYPE_NetStatsDbContent: nameString.append("INFO_TYPE_NetStatsDbContent\n"); break;
		case INFO_TYPE_MacSummaryStats: nameString.append("INFO_TYPE_MacSummaryStats\n"); break;
		case INFO_TYPE_MacConnStats: nameString.append("INFO_TYPE_MacConnStats\n"); break;
		case INFO_TYPE_MessageNextPrevHop: nameString.append("INFO_TYPE_MessageNextPrevHop\n"); break;
		case INFO_TYPE_MessageAddrInfo: nameString.append("INFO_TYPE_MessageAddrInfo\n"); break;
		case INFO_TYPE_ForwardInfo: nameString.append("INFO_TYPE_ForwardInfo\n"); break;
		case INFO_TYPE_PhyConnCrossPartition: nameString.append("INFO_TYPE_PhyConnCrossPartition\n"); break;
		case INFO_TYPE_ForwardTcpHeader: nameString.append("INFO_TYPE_ForwardTcpHeader\n"); break;
		case INFO_TYPE_PadLen: nameString.append("INFO_TYPE_PadLen\n"); break;
		case INFO_TYPE_IAHEP_RUTNG: nameString.append("INFO_TYPE_IAHEP_RUTNG\n"); break;
		case INFO_TYPE_RPProcessed: nameString.append("INFO_TYPE_RPProcessed\n"); break;
		case INFO_TYPE_JAM: nameString.append("INFO_TYPE_JAM\n"); break;
		case INFO_TYPE_IAHEP_NextHop: nameString.append("INFO_TYPE_IAHEP_NextHop\n"); break;
		case INFO_TYPE_TransportToAppData: nameString.append("INFO_TYPE_TransportToAppData\n"); break;
		case INFO_TYPE_NetworkCesIncSincgarsType: nameString.append("INFO_TYPE_NetworkCesIncSincgarsType\n"); break;
		case INFO_TYPE_QosReplyPacket: nameString.append("INFO_TYPE_QosReplyPacket\n"); break;
		case INFO_TYPE_MIQoSAgePacket: nameString.append("INFO_TYPE_MIQoSAgePacket\n"); break;
		case INFO_TYPE_HSLSRegionId: nameString.append("INFO_TYPE_HSLSRegionId\n"); break;
		case INFO_TYPE_HaipeNextHop: nameString.append("INFO_TYPE_HaipeNextHop\n"); break;
		case INFO_TYPE_MacCesSrwPort: nameString.append("INFO_TYPE_MacCesSrwPort\n"); break;
		case INFO_TYPE_ROSPFRedirectMetadata: nameString.append("INFO_TYPE_ROSPFRedirectMetadata\n"); break;
		case INFO_TYPE_IPPacketSentTime: nameString.append("INFO_TYPE_IPPacketSentTime\n"); break;
		case INFO_TYPE_IpHeaderSize: nameString.append("INFO_TYPE_IpHeaderSize\n"); break;
		case INFO_TYPE_DelayInfo: nameString.append("INFO_TYPE_DelayInfo\n"); break;
		case INFO_TYPE_DidDropPacket: nameString.append("INFO_TYPE_DidDropPacket\n"); break;
		case INFO_TYPE_SRWCNRVoice: nameString.append("INFO_TYPE_SRWCNRVoice\n"); break;
		case INFO_TYPE_SRWConcatMsg: nameString.append("INFO_TYPE_SRWConcatMsg\n"); break;
		case INFO_TYPE_SRW_MACInfo: nameString.append("INFO_TYPE_SRW_MACInfo\n"); break;
		case INFO_TYPE_SRW_IntranetCNRApp: nameString.append("INFO_TYPE_SRW_IntranetCNRApp\n"); break;
		case INFO_TYPE_JNE_JREAP_AvatarInfo: nameString.append("INFO_TYPE_JNE_JREAP_AvatarInfo\n"); break;
		case INFO_TYPE_MODE5: nameString.append("INFO_TYPE_MODE5\n"); break;
		case INFO_TYPE_SNMPV3: nameString.append("INFO_TYPE_SNMPV3\n"); break;
		case INFO_TYPE_Dot16BurstInfo: nameString.append("INFO_TYPE_Dot16BurstInfo\n"); break;
		case INFO_TYPE_LtePhyDlTtiInfo: nameString.append("INFO_TYPE_LtePhyDlTtiInfo\n"); break;
		//case INFO_TYPE_LtePhyTxInfo: nameString.append("INFO_TYPE_LtePhyTxInfo\n"); break;
		case INFO_TYPE_LtePhyCqiInfo: nameString.append("INFO_TYPE_LtePhyCqiInfo\n"); break;
		case INFO_TYPE_LtePhyRiInfo: nameString.append("INFO_TYPE_LtePhyRiInfo\n"); break;
		case INFO_TYPE_LtePhySrsInfo: nameString.append("INFO_TYPE_LtePhySrsInfo\n"); break;
		case INFO_TYPE_LtePhyPss: nameString.append("INFO_TYPE_LtePhyPss\n"); break;
		case INFO_TYPE_LtePhyRandamAccessGrant: nameString.append("INFO_TYPE_LtePhyRandamAccessGrant\n"); break;
		case INFO_TYPE_LtePhyRrcConnectionSetupComplete: nameString.append("INFO_TYPE_LtePhyRrcConnectionSetupComplete\n"); break;
		case INFO_TYPE_LtePhyRrcConnectionReconfComplete: nameString.append("INFO_TYPE_LtePhyRrcConnectionReconfComplete\n"); break;
		case INFO_TYPE_LtePhyRandamAccessTransmitPreamble: nameString.append("INFO_TYPE_LtePhyRandamAccessTransmitPreamble\n"); break;
		case INFO_TYPE_LtePhyRandamAccessTransmitPreambleTimerDelay: nameString.append("INFO_TYPE_LtePhyRandamAccessTransmitPreambleTimerDelay\n"); break;
		case INFO_TYPE_LtePhyRandamAccessTransmitPreambleInfo: nameString.append("INFO_TYPE_LtePhyRandamAccessTransmitPreambleInfo\n"); break;
		case INFO_TYPE_LtePhyLtePhyToMacInfo: nameString.append("INFO_TYPE_LtePhyLtePhyToMacInfo\n"); break;
		case INFO_TYPE_LteDciForUl: nameString.append("INFO_TYPE_LteDciForUl\n"); break;
		case INFO_TYPE_LteDci0Info: nameString.append("INFO_TYPE_LteDci0Info\n"); break;
		case INFO_TYPE_LteDci1Info: nameString.append("INFO_TYPE_LteDci1Info\n"); break;
		case INFO_TYPE_LteDci2aInfo: nameString.append("INFO_TYPE_LteDci2aInfo\n"); break;
		case INFO_TYPE_LteMacDestinationInfo: nameString.append("INFO_TYPE_LteMacDestinationInfo\n"); break;
		//case INFO_TYPE_LteMacNoTransportBlock: nameString.append("INFO_TYPE_LteMacNoTransportBlock\n"); break;

		case INFO_TYPE_LteMacPeriodicBufferStatusReport: nameString.append("INFO_TYPE_LteMacPeriodicBufferStatusReport\n"); break;
		case INFO_TYPE_LteMacRRELCIDFLWith7bitSubHeader: nameString.append("INFO_TYPE_LteMacRRELCIDFLWith7bitSubHeader\n"); break;
		case INFO_TYPE_LteMacRRELCIDFLWith15bitSubHeader: nameString.append("INFO_TYPE_LteMacRRELCIDFLWith15bitSubHeader\n"); break;
		case INFO_TYPE_LteMacRRELCIDSubHeader: nameString.append("INFO_TYPE_LteMacRRELCIDSubHeader\n"); break;
		case INFO_TYPE_LteMacMultiplexingMsg: nameString.append("INFO_TYPE_LteMacMultiplexingMsg\n"); break;
		case INFO_TYPE_LteMacNumMultiplexingMsg: nameString.append("INFO_TYPE_LteMacNumMultiplexingMsg\n"); break;
		case INFO_TYPE_LteMacTxInfo: nameString.append("INFO_TYPE_LteMacTxInfo\n"); break;
		case INFO_TYPE_LteRlcAmSduToPdu: nameString.append("INFO_TYPE_LteRlcAmSduToPdu\n"); break;
		case INFO_TYPE_LteRlcAmPduFormatFixed: nameString.append("INFO_TYPE_LteRlcAmPduFormatFixed\n"); break;
		case INFO_TYPE_LteRlcAmPduSegmentFormatFixed: nameString.append("INFO_TYPE_LteRlcAmPduSegmentFormatFixed\n"); break;
		case INFO_TYPE_LteRlcAmPduFormatExtension: nameString.append("INFO_TYPE_LteRlcAmPduFormatExtension\n"); break;
		case INFO_TYPE_LteRlcAmStatusPduPduFormatFixed: nameString.append("INFO_TYPE_LteRlcAmStatusPduPduFormatFixed\n"); break;
		case INFO_TYPE_LteRlcAmStatusPduPduFormatExtension: nameString.append("INFO_TYPE_LteRlcAmStatusPduPduFormatExtension\n"); break;
		case INFO_TYPE_LteRlcAmStatusPdu: nameString.append("INFO_TYPE_LteRlcAmStatusPdu\n"); break;
		case INFO_TYPE_LteRlcAmResetData: nameString.append("INFO_TYPE_LteRlcAmResetData\n"); break;
		case INFO_TYPE_LteRlcAmPdcpPduInfo: nameString.append("INFO_TYPE_LteRlcAmPdcpPduInfo\n"); break;
		case INFO_TYPE_LtePdcpTxInfo: nameString.append("INFO_TYPE_LtePdcpTxInfo\n"); break;
		case INFO_TYPE_LtePdcpSrcMsg: nameString.append("INFO_TYPE_LtePdcpSrcMsg\n"); break;
		case INFO_TYPE_LteEpcAppContainer: nameString.append("INFO_TYPE_LteEpcAppContainer\n"); break;
		case INFO_TYPE_LtePdcpDiscardTimerInfo: nameString.append("INFO_TYPE_LtePdcpDiscardTimerInfo\n"); break;
		case INFO_TYPE_LtePdcpBufferType: nameString.append("INFO_TYPE_LtePdcpBufferType\n"); break;
		case INFO_TYPE_LtePhyRrcMeasReport: nameString.append("INFO_TYPE_LtePhyRrcMeasReport\n"); break;
		case INFO_TYPE_LtePhyRrcConnReconf: nameString.append("INFO_TYPE_LtePhyRrcConnReconf\n"); break;
		//case INFO_TYPE_LteStatsDbSduPduInfo: nameString.append("INFO_TYPE_LteStatsDbSduPduInfo\n"); break;
		case INFO_TYPE_Dot11nTimerInfo: nameString.append("INFO_TYPE_Dot11nTimerInfo\n"); break;
		case INFO_TYPE_Dot11nBER: nameString.append("INFO_TYPE_Dot11nBER\n"); break;
		case INFO_TYPE_Gts_Trigger_Precedence: nameString.append("INFO_TYPE_Gts_Trigger_Precedence\n"); break;
		case INFO_TYPE_Gts_Slot_Start: nameString.append("INFO_TYPE_Gts_Slot_Start\n"); break;
		case INFO_TYPE_ZigbeeApp_Info: nameString.append("INFO_TYPE_ZigbeeApp_Info\n"); break;

		case INFO_TYPE_FxPhyTxInfo: nameString.append("INFO_TYPE_FxPhyTxInfo\n"); break;
		case INFO_TYPE_FxPhyRandamAccessRequest: nameString.append("INFO_TYPE_FxPhyRandamAccessRequest\n"); break;
		case INFO_TYPE_FxPhyRrcConnectionSetupComplete: nameString.append("INFO_TYPE_FxPhyRrcConnectionSetupComplete\n"); break;
		case INFO_TYPE_FxPhyRandamAccessResponse: nameString.append("INFO_TYPE_FxPhyRandamAccessResponse\n"); break;
		case INFO_TYPE_FxSmacNoTransportBlock: nameString.append("INFO_TYPE_FxSmacNoTransportBlock\n"); break;
		case INFO_TYPE_FxSmacTxInfo: nameString.append("INFO_TYPE_FxSmacTxInfo\n"); break;
