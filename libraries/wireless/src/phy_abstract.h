...
#define PHY_ABSTRACT_DEFAULT_DATA_RATE           2000000
...
clocktype PhyAbstractGetFrameDuration(PhyData* thisPhy, int size, int dataRate);
...
void PhyAbstractSetDataRate(Node* node, int phyIndex, int dataRate);
