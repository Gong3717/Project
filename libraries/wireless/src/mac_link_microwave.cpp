                                     ...
                                     Message *msg)
{
    ...
    assert(partition->terrainData->getCoordinateSystem() == LATLONALT);
    ...
    if (distance > maxdistance){
      printf( " \n Destination %d\n\n",node->nodeId);
      ERROR_ReportError("Above destination node is out of reach\n");
    }
                                  ...
                                  Message *msg)
{
    ...
    double pathloss = WirelessLinkcalculatepathloss(node, link, msg);
        ...
        (sourcesiteparameter->polarization == destsiteparameter->polarization))
    {
        ...
        rxpower =
            sourcesiteparameter->TxPower_dBm + sourcesiteparameter->AntennaGain
            + destsiteparameter->AntennaGain
            - sourcesiteparameter->AntennaCableLoss
            - destsiteparameter->AntennaCableLoss - pathloss;
