...
//receive-only
	...
	// MSG types for FX
	MSG_MAC_FX_TtiTimerExpired,

	MSG_MAC_FX_RaResponseWaitingTimerExpired,

	MSG_SAC_FX_DiscardTimerExpired,
	...
	//Added by WLH
	MSG_RRC_FX_WaitRrcConnectedTimerExpired, // t-WaitRrcConnected Timer
	MSG_RRC_FX_WaitRrcConnectedReconfTimerExpired, // t-WaitRrcConnectedReconf Timer
	MSG_MAC_FX_RELOCprep,
	MSG_MAC_FX_X2_RELOCoverall,
	MSG_MAC_FX_X2_WaitSnStatusTransfer,
	MSG_MAC_FX_WaitAttachUeByHo,
	MSG_MAC_FX_X2_WaitEndMarker,
	MSG_MAC_FX_S1_WaitPathSwitchReqAck, MSG_PHY_FX_TransmissionEndInEstablishment,
	MSG_PHY_FX_StartTransmittingSignalInEstablishment,
	MSG_PHY_FX_NonServingCellMeasurementInterval,
	MSG_PHY_FX_NonServingCellMeasurementPeriod,
	MSG_PHY_FX_CheckingConnection,
	MSG_PHY_FX_InterferenceMeasurementTimerExpired,
	MSG_RRC_FX_WaitPowerOnTimerExpired,
	MSG_RRC_FX_WaitPowerOffTimerExpired,
	MSG_SLC_FX_PollRetransmitTimerExpired, // t-PollRetrunsmit
	MSG_SLC_FX_ReorderingTimerExpired, // t-Reordering
	MSG_SLC_FX_StatusProhibitTimerExpired, // t-StatusProhibit
	MSG_SLC_FX_ResetTimerExpired, // reset timer
	MSG_PDCP_FX_DelayedPdcpSdu,
	MSG_RRC_FX_PeriodicalReportTimerExpired, // periodical report timer
	MSG_PDCP_FX_DiscardTimerExpired,
