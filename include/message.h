...
enum MessageInfoType
{
	...
	// FX SPHY
	INFO_TYPE_FxPhyTxInfo,
	INFO_TYPE_FxPhyCqiInfo,	
	INFO_TYPE_FxPhyFxPhyToMacInfo,


	//Added by WLH
	INFO_TYPE_FxPhySrsInfo,
	...
	INFO_TYPE_FxPhyRandamAccessResponse, 

	//INFO_TYPE_FxPhyEpochInfo,


	// 用户站
		INFO_TYPE_FxPhyRandamAccessRequest,
		INFO_TYPE_FxPhyRrcConnectionRequest,
		INFO_TYPE_FxPhyRrcConnectionSetup,
	INFO_TYPE_FxPhyRrcConnectionSetupComplete, 
		INFO_TYPE_FxPhyRrcHandoverRequest,
		INFO_TYPE_FxPhyRrcConnectionReconfiguration,
		INFO_TYPE_FxPhyRrcConnectionReconfigurationComplete,

	// 卫星
	INFO_TYPE_FxPhyBeamInfo,
		INFO_TYPE_FxPhyVirtualBeamChannelsInfo,


	// FX SMAC
	INFO_TYPE_FxSmacNoTransportBlock, // this info has no corresponding struct
	INFO_TYPE_FxSmacTxInfo,

	INFO_TYPE_FxSmacRRELCIDFLWith15bitSubHeader,
	INFO_TYPE_FxSmacMultiplexingMsg,
	INFO_TYPE_FxSmacNumMultiplexingMsg,
	INFO_TYPE_FxStatsDbSduPduInfo,
	//FX SLC
	INFO_TYPE_FxSlcAmSacPduInfo,
	INFO_TYPE_FxSlcAmPduFormatFixed,
	INFO_TYPE_FxSlcAmPduSegmentFormatFixed,
	INFO_TYPE_FxSlcAmPduFormatExtension,
	INFO_TYPE_FxSlcAmStatusPduPduFormatFixed,
	INFO_TYPE_FxSlcAmStatusPduPduFormatExtension,
	INFO_TYPE_FxSlcAmSduToPdu,
	//FX SAC
	INFO_TYPE_FxSacTxInfo,

	// FX Layer2
	INFO_TYPE_FxSmacDestinationInfo,
